...
/**
 * Um botão flutuante que direciona o utilizador para o WhatsApp para obter ajuda.
 */
const FloatingHelpButton = () => {
  const whatsappNumber = '351961281939';
  const defaultMessage = 'Olá! Gostaria de tirar uma dúvida sobre um produto.';
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-transform duration-200 ease-in-out hover:scale-110 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
